        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 w-full text-center sm:px-6 lg:px-8 lg:text-left" id="hero-content">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <div 
                className="inline-flex items-center gap-2 px-3 py-1 bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[#3B82F6] text-[10px] font-bold uppercase tracking-widest mb-6 w-fit rounded-none"
                id="hero-badge"
              >
                <span className="w-2 h-2 rounded-full bg-[#3B82F6] animate-pulse"></span>
                Delhi NCR’s Ultimate Luxury Fitness Citadel
              </div>

              <h1 className="text-5xl font-black uppercase tracking-tighter text-white sm:text-7xl italic leading-[0.95]" id="hero-title">
                BUILD STRENGTH.<br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4" id="hero-ctas">
                <button
                  ...
                  className="px-8 py-3.5 bg-[#3B82F6] text-white text-xs font-bold uppercase tracking-widest shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:bg-[#2563EB] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] transition-all cursor-pointer"
                  id="hero-join-cta"
                >
                  Join the Iron Core
                </button>
            ...
            <div className="hidden lg:col-span-4 lg:flex justify-end" id="hero-card-supplement">
              <div className="bg-[#151515] border border-white/10 p-6 w-80 shadow-2xl backdrop-blur-xl relative">
                <div className="absolute -top-3.5 -right-3.5 flex h-10 w-10 items-center justify-center rounded-xl bg-[#3B82F6] text-white font-black rotate-12 shadow-[0_0_15px_rgba(59,130,246,0.5)] text-sm font-mono">
                  100%
                </div>
                <div className="text-[10px] font-bold text-[#F97316] uppercase tracking-widest mb-1">PROMOTION OFFER</div>
                <div className="text-2xl font-black mb-1 italic text-white">ELITE MEMBERSHIP</div>
                <div className="text-3xl font-black text-white flex items-start gap-1 mb-4 font-mono">
                  <span className="text-sm mt-1 text-[#3B82F6]">₹</span>3,999<span className="text-sm text-zinc-500 font-normal lowercase">/mo</span>
                </div>
                
                <p className="text-[11px] text-zinc-400 leading-relaxed mb-4">
                  Join Delhi NCR's athletic sanctuary with zero admission fees this week. Free customized bio-impedance composition tracking included.
                </p>
                ...
                <ul className="space-y-2 mb-6 border-t border-white/5 pt-4">
                  <li className="text-[10px] text-zinc-350 flex items-center gap-2 uppercase tracking-wide">
                    <span className="text-[#3B82F6] font-bold">•</span> 24/7 Floor Access
                  </li>
                  <li className="text-[10px] text-zinc-350 flex items-center gap-2 uppercase tracking-wide">
                    <span className="text-[#3B82F6] font-bold">•</span> 2 Sessions with Personal Trainer
                  </li>
                  <li className="text-[10px] text-zinc-350 flex items-center gap-2 uppercase tracking-wide">
                    <span className="text-[#3B82F6] font-bold">•</span> Custom Macro Blueprint
                  </li>
                </ul>
                ...
                <button 
                  ...
                  className="w-full py-3 bg-white text-black font-black uppercase text-[10px] tracking-widest hover:bg-[#3B82F6] hover:text-white transition-all cursor-pointer"
                  id="hero-teaser-btn"
                >
                  Secure My Spot
                </button>
            ...
            {facilitiesData.map((f) => (
              <button
                ...
                className={`group flex items-center justify-between rounded-xl px-5 py-4 text-left transition-all ${
                  activeFacility === f.id
                    ? 'bg-[#3B82F6]/10 border-l-4 border-[#3B82F6] text-white'
              ...
              >
                ...
                <ChevronRight className={`h-4 w-4 text-[#3B82F6] transition-transform ${activeFacility === f.id ? 'translate-x-1' : 'opacity-0 group-hover:opacity-100'}`} />
              </button>
            ))}
          </div>
              ...
              <div className="relative z-10 p-6 sm:p-10 space-y-4">
                ...
                <div className="flex gap-4 pt-2">
                  <button
                    ...
                    className="px-5 py-2.5 text-xs font-black uppercase bg-white text-black hover:bg-[#3B82F6] hover:text-white transition-all cursor-pointer"
                  >
                    Tour In Person
                  </button>
                  <button
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" id="home-motivational-banner">
        <div className="relative rounded-2xl overflow-hidden bg-[#151515] border border-white/10 p-8 sm:p-14 text-center space-y-6">
          ...
          <div className="relative z-10 max-w-xl mx-auto space-y-4">
            <span className="text-[10px] font-black tracking-[0.25em] text-[#3B82F6] uppercase">STRETCH YOUR POTENTIAL</span>
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Step onto Delhi NCR's premium flooring. Meet coaches with continuous records of producing verifiable athletic milestones. First session is absolutely free of charge.
            </p>
            <div className="pt-2">
              <button
                onClick={() => {
                ...
                className="px-6 py-3.5 text-xs font-black uppercase bg-[#3B82F6] text-white shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:bg-[#2563EB] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] transition-all cursor-pointer"
              >
