        ...
        {!isSubmitted ? (
          ...
          >
            ...
            <div className="text-center space-y-4 mb-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[#3B82F6] text-[10px] font-black uppercase tracking-widest mb-2 w-fit rounded-none" id="trial-offer-badge">
                <span className="w-2 h-2 rounded-full bg-[#3B82F6] animate-pulse"></span>
                Delhi NCR exclusive day pass
              </div>
            ...
            <div className="rounded-none border border-white/10 bg-[#151515] p-5 sm:p-8" id="trial-form-card">
              <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        ...
                        className={`rounded-none border p-3 text-center text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer ${
                          formData.selectedDay === day
                            ? 'border-[#3B82F6] bg-[#3B82F6]/10 text-white shadow-[0_0_15px_rgba(59,130,246,0.2)]'
                  ...
                  <div className="space-y-2">
                    {timeSlots.map((ts) => (
                      ...
                      >
                        ...
                        {formData.preferredTime === ts.id && (
                          <span className="rounded-none bg-[#3B82F6] px-2 py-0.5 text-black text-[9px] font-black uppercase">Active</span>
                        )}
                      </button>
                    ))}
                  </div>
                ...
                <div className="rounded-none bg-[#0D0D0D] border border-white/10 p-4 flex gap-3 text-xs align-top">
                  <ShieldAlert className="h-5 w-5 text-[#3B82F6] flex-shrink-0 mt-0.5" />
                  <p className="text-zinc-500 leading-relaxed max-w-2xl text-[11px] font-semibold">
                    By submitting this reservation pass, you verify Delhi NCR residency for active validation. Please carry a valid identification marker (Aadhaar or work ID card) on your scheduled walkthrough reception check-in.
                  </p>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-4 text-center text-xs font-black uppercase tracking-widest bg-[#3B82F6] text-black shadow-2xl hover:bg-white hover:text-black transition-all cursor-pointer rounded-none"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="relative rounded-none overflow-hidden bg-[#151515] border border-white/10 p-6 text-left space-y-4 shadow-2xl">
                ...
                <div className="flex items-center justify-between border-b border-white/5 pb-4">
                  <div>
                    <span className="text-[10px] font-mono text-[#3B82F6] font-bold uppercase tracking-widest">GUEST INVITATION PASS</span>
                    <h3 className="text-sm font-black text-white mt-1 uppercase italic">IRON FORGE DELUXE</h3>
                  </div>
                  <span className="text-xs font-black font-mono text-black bg-[#3B82F6] border border-[#3B82F6]/20 px-3 py-1.5">
                    {voucherId}
                  </span>
                </div>
              ...
              <div className="rounded-none border border-white/10 bg-[#151515] p-5 text-left space-y-3.5">
                <h4 className="text-xs font-black uppercase text-[#3B82F6] tracking-widest">Direct Next Procedures</h4>
                <ul className="space-y-2.5 text-xs text-zinc-400 font-medium leading-relaxed">
                  <li className="flex items-start">
                    <span className="text-[#3B82F6] font-black mr-2 font-mono">01.</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-[#3B82F6] font-black mr-2 font-mono">02.</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-[#3B82F6] font-black mr-2 font-mono">03.</span>
