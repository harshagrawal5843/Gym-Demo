...
export default function Transformations({ setCurrentPage }: TransformationsProps) {
  ...
  const stats = [
    { label: 'Visceral Weight Lost', value: '8,450 kg', desc: 'Over NCR active registers' },
    ...
    <div className="space-y-24 py-16 pb-24 font-sans text-white border-none" id="transformations-page">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-4" id="transformations-header">
        ...
        <p className="mx-auto max-w-2xl text-sm text-zinc-400 font-semibold text-center leading-relaxed">
          We do not trade on fake marketing claims or soft light photography. These are actual Iron Forge members who executed their customized training & macros blueprints.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          {stats.map((stat, idx) => (
            <div key={idx} className="rounded-none border border-white/10 bg-[#151515] p-6 sm:p-8 space-y-2 hover:border-white/20 transition-all">
              ...
              <p className="text-[10px] text-zinc-500 font-mono italic uppercase tracking-wider">{stat.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12" id="transformations-interactive-showcase">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 rounded-none bg-[#3B82F6]/10 px-3.5 py-1 text-[10px] font-black uppercase text-[#3B82F6] border border-[#3B82F6]/20">
            <Trophy className="h-3 w-3" />
            Interactive Visual Slider
          </div>
          <h2 className="text-2xl font-black uppercase text-white sm:text-3.5xl italic">
          ...
          <div className="lg:col-span-5 space-y-6 bg-[#151515] p-6 sm:p-8 rounded-none border border-white/10 flex flex-col justify-between" id="transformation-metadata">
            <div>
              <div className="flex gap-4 border-b border-white/5 pb-4">
                <div className="bg-[#3B82F6]/15 rounded-none h-11 w-11 flex items-center justify-center text-[#3B82F6] border border-[#3B82F6]/25 flex-shrink-0">
                  <Sparkles className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-md font-black text-white uppercase tracking-wider italic">{selectedStory.name}</h3>
              ...
              <div className="grid grid-cols-3 gap-3 pt-6">
                <div className="bg-[#0D0D0D] p-3 rounded-none border border-white/5 text-center">
                  ...
                  <div className="text-md text-[#3B82F6] font-black font-mono mt-1">{selectedStory.beforeWeight}</div>
                </div>
                <div className="bg-[#0D0D0D] p-3 rounded-none border border-white/5 text-center">
              ...
              <div className="space-y-2 pt-6">
                <div className="text-[9px] uppercase tracking-widest text-[#3B82F6] font-black">Member Testimonial Story</div>
            ...
            <div className="relative rounded-none overflow-hidden bg-[#151515] border border-white/10 p-4 flex flex-col items-center justify-between w-full">
              ...
              <div className="flex rounded-none bg-[#0D0D0D] border border-white/10 p-1 mb-4 h-11 w-full max-w-[280px]">
                ...
                <button
                  ...
                  className={`flex-1 rounded-none text-xs font-black uppercase tracking-widest transition-all cursor-pointer ${
                    showAfterState ? 'bg-[#3B82F6] text-black' : 'text-zinc-550 hover:text-white'
                  }`}
                >
                  AFTER
                </button>
              ...
              <div className="relative h-[320px] sm:h-[420px] w-full rounded-none overflow-hidden bg-black border border-white/5">
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-[#0D0D0D]/90 rounded-none border border-white/10 p-3 flex sm:items-center justify-between gap-2 max-w-md backdrop-blur-md">
                    ...
                    <span className="rounded-none bg-[#3B82F6]/10 border border-[#3B82F6]/20 px-2.5 py-1 text-[9px] font-black text-[#3B82F6] font-mono">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12" id="success-directory">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            <h3 className="text-xl font-black uppercase tracking-widest text-white italic">Verified Client Logs</h3>
          ...
          {filteredStories.map((item) => (
            <div key={item.id} className="p-6 rounded-none border border-white/10 bg-[#151515] space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-black text-white uppercase tracking-wider text-sm italic">{item.name}</h4>
                  <p className="text-[10px] text-zinc-550 uppercase tracking-widest font-mono mt-0.5">Duration: {item.duration}</p>
                </div>
                <span className="block px-2.5 py-1 rounded-none bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[9px] font-black uppercase text-[#3B82F6] font-mono">
              ...
              <div className="pt-2 border-t border-white/5 flex justify-between items-center text-[9px] font-black uppercase tracking-widest text-zinc-500">
                ...
                <span className="text-[#3B82F6]">Verified Form Update</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12" id="transformations-video-section">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl font-black uppercase text-white sm:text-3xl italic">
          ...
          <div className="rounded-none border border-white/10 bg-[#151515] overflow-hidden flex flex-col justify-between p-5 sm:p-6 gap-6" id="video-mock-card-1">
            <div className="relative h-56 rounded-none overflow-hidden bg-black/45 border border-white/15 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative flex h-14 w-14 items-center justify-center rounded-none bg-[#3B82F6] text-black shadow-lg cursor-pointer hover:bg-white active:scale-95 transition-all">
                  <Play className="h-6 w-6 ml-1 fill-black text-black" />
                </div>
              </div>
              <span className="absolute bottom-3 left-3 bg-[#0D0D0D]/80 px-2.5 py-1 rounded-none text-[9px] text-[#3B82F6] font-mono tracking-widest border border-white/10">
                04:15 OVERALL TRANSCRIPT
              </span>
            </div>
            
            <div className="space-y-3">
              <h4 className="font-black text-white uppercase tracking-wider text-sm flex items-center justify-between italic">
                <span>Riddhima Sen, Corporate Manager</span>
                <span className="text-[10px] font-bold text-zinc-500 font-mono tracking-widest">Delhi NCR</span>
              </h4>
              <p className="text-xs text-zinc-400 font-semibold italic leading-relaxed">
                "Balancing a 11-hour workload was driving my health off a cliff. The custom macro plans designed by Elena Rostova coupled with 3 focused strength days at Iron Forge turned things around entirely. I feel 15 years younger and have massive daily clarity."
              </p>
            </div>
          </div>
          ...
          <div className="rounded-none border border-white/10 bg-[#151515] overflow-hidden flex flex-col justify-between p-5 sm:p-6 gap-6" id="video-mock-card-2">
            ...
            <div className="space-y-3">
              <h4 className="font-black text-white uppercase tracking-wider text-sm flex items-center justify-between italic">
                ...
                <span className="text-[10px] font-bold text-zinc-500 font-mono tracking-widest font-mono">Gurugram HQ</span>
              </h4>
              <p className="text-xs text-zinc-400 font-semibold italic leading-relaxed">
                "I was seeking serious Olympic plates and platform coaching. Under Marcus Steel's structured leverage optimizations. My deadlift peak scaled from 180kg to 255kg in less than six months. The lifting deck at Iron Forge represents the gold standard."
              </p>
            </div>
          </div>
        </div>
