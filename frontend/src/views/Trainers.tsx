...
export default function Trainers({ setCurrentPage }: TrainersProps) {
  ...
  const filteredTrainers = coaches.filter(coach => {
    ...
    <div className="space-y-24 py-16 pb-24 font-sans text-white" id="trainers-page-container">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-4" id="trainers-header">
        <span className="text-xs font-black uppercase tracking-widest text-[#FF6600]">
          Birgunj, Nepal’s Prime Sports Specialists
        </span>
        ...
        <p className="mx-auto max-w-2xl text-sm text-zinc-400 font-semibold leading-relaxed">
          We do not hire generic flooring assistants. All Fitex Gym specialists are internationally certified coaches, kinesiologists, and elite competitive athletes.
        </p>
            ...
            return (
              <div
                ...
                className={`relative rounded-none overflow-hidden border transition-all duration-300 bg-[#151515] ${
                  isExpanded ? 'border-[#FF6600] shadow-2xl' : 'border-white/10 hover:border-white/20'
                }`}
              ...
              >
                ...
                <div className="p-5 sm:p-6 space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    {/* Visual Stamp */}
                    <div className="rounded-none bg-[#FF6600]/10 border border-[#FF6600]/20 p-1.5 text-[#FF6600]">
                  ...
                  <div className="grid grid-cols-2 gap-3 pb-2">
                    <div className="bg-[#0D0D0D] p-2.5 rounded-none border border-white/5 text-center">
                      <div className="text-[9px] text-[#FF6600] uppercase font-bold tracking-widest">Success Metric</div>
                  ...
                  <div className="border-t border-white/5 pt-4 flex flex-col gap-3">
                    ...
                    >
                      ...
                      {isExpanded ? <ChevronUp className="h-4 w-4 text-[#FF6600]" /> : <ChevronDown className="h-4 w-4 text-[#FF6600]" />}
                    </button>
                    ...
                    <AnimatePresence>
                      {isExpanded && (
                        ...
                        >
                          ...
                          <div className="bg-[#0D0D0D] p-3.5 rounded-none border border-white/5 text-xs text-zinc-400 leading-relaxed font-semibold">
                            "{coach.quote}"
                          </div>
                          ...
                          <div className="flex gap-2 pt-2 border-t border-white/5">
                            <button
                              ...
                              className="flex-1 rounded-none bg-white text-center py-2 text-xs font-black uppercase text-black hover:bg-[#FF6600] hover:text-white transition-all cursor-pointer"
                            >
                              Reserve Slot
                            </button>
                            <a
                              href={`mailto:${coach.name.toLowerCase().replace(' ', '')}@ironforge.com`}
                              className="flex h-8.5 w-8.5 items-center justify-center rounded-none bg-[#0D0D0D] border border-white/10 text-zinc-400 hover:text-white hover:border-[#FF6600]"
                            >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" id="trainers-accreditations">
        <div className="rounded-none border border-white/10 bg-[#151515] p-8 sm:p-12 text-center space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-xs text-zinc-500 leading-relaxed font-semibold">
            All coaching schedules are structured under the direct biomechanics supervision of Dr. Elena Rostova. Routine assessments are executed quarterly to maintain Birgunj's safest joint-injury preventative protocols.
          </p>
        </div>
      </section>
