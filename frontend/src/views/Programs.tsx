          ...
          {programsData.map((prog) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-black/45">
                ...
                <span className="absolute top-4 left-4 inline-block rounded-none bg-[#FF6600] px-2.5 py-1 text-[9px] font-black uppercase text-black tracking-widest font-mono">
                  {prog.intensity} TYPE
                </span>
              </div>
              ...
              <div className="p-6 space-y-4 flex-grow flex flex-col justify-between">
                <div className="space-y-3">
                  <h3 className="text-sm font-black uppercase tracking-wider text-white group-hover:text-[#FF6600] transition-colors">
                    {prog.title}
                  </h3>
                  ...
                  <ul className="space-y-1.5 text-xs">
                    {prog.benefits.map((ben, bidx) => (
                      <li key={bidx} className="flex items-start text-zinc-400 font-semibold leading-normal">
                        <span className="text-[#FF6600] font-bold mr-2">•</span>
                        <span>{ben}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <div className="px-6 pb-6 pt-2">
                <button
                  ...
                  className="flex w-full items-center justify-between gap-2.5 rounded-none bg-[#0D0D0D] border border-white/10 px-4 py-3.5 text-xs font-black uppercase tracking-widest text-[#FF6600] hover:bg-[#FF6600] hover:text-black hover:border-white/20 transition-all cursor-pointer"
                >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12" id="classes-schedule">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/10 pb-6" id="schedule-header">
          <div className="space-y-3">
            ...
            <h2 className="text-2xl font-black uppercase text-white sm:text-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="classes-directory-grid">
          {classesData.map((cls) => (
            <div key={cls.id} className="p-6 rounded-none border border-white/10 bg-[#151515] space-y-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-none bg-[#FF6600]/10 text-[#FF6600] border border-[#FF6600]/20">
              ...
              <div className="space-y-1.5">
                ...
                <h4 className="text-sm font-black uppercase text-white tracking-wider">{cls.name}</h4>
                <p className="text-xs text-zinc-400 leading-relaxed font-semibold">
                  {cls.desc}
                </p>
              </div>
